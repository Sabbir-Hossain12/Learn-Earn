                ...
                <form method="post" action="{{route('admin.basicinfo.store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        oninput="favImgPrev.src=window.URL.createObjectURL(this.files[0])"
                                                        class="form-control" type="file" name="fav_icon"
                                                        id="fav_icon">
                                                    @if($basicInfo && $basicInfo->fav_icon)
                                                        <img id="favImgPrev" class="mt-1"
                                                             src="{{asset($basicInfo->fav_icon)}}"
                                                ...
                                                <div class="mb-3">
                                                    <label for="about_text" class="form-label">Short
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3 mt-lg-0">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        oninput="lLogoImgPrev.src=window.URL.createObjectURL(this.files[0])"
                                                        class="form-control" type="file" name="light_logo"
                                                        id="light_logo">
                                                    @if($basicInfo && $basicInfo->light_logo)
                                                        <img id="lLogoImgPrev" class="mt-1"
                                                             src="{{asset($basicInfo->light_logo)}}"
                                                             height="60px" width="200px" alt=""/>
                                                    @endif
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="opening_hours_text" class="form-label">Opening Hour
                                                        Text</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="copyright_text" class="form-label">Copyright
                                                        Text</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="marquee_text" class="form-label">Marquee Text
                                                        (Announcement)</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">Certificate Information</h4>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="mb-3">
                                                    <label for="signature_author" class="form-label">Signature
                                                        Author</label>
                                                    <input type="text" class="form-control" id="signature_author"
                                                           name="signature_author"
                                                           value="{{$basicInfo->signature_author ?? ''}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-3 mt-lg-0">
                                                <div class="mb-3">
                                                    <label for="meta_image" class="form-label">Signature Image</label>
                                                    <input type="file"
                                                           oninput="signatureImgPrev.src=window.URL.createObjectURL(this.files[0])"
                                                           class="form-control" name="signature_text">

                                                    @if($basicInfo && $basicInfo->signature_text)
                                                        <img id="signatureImgPrev" class="mt-1"
                                                             src="{{asset($basicInfo->signature_text)}}"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title text-center">Agreement Information</h4>
                                </div>
                                            ...
                                            <div class="mt-3 mt-lg-0">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if($basicInfo && $basicInfo->meta_image)
                                                        <img id="metaLogoImgPrev" class="mt-1"
                                                             src="{{asset($basicInfo->meta_image)}}"
