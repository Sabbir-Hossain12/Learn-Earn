...
{{--                                           id="example-email-input" value="{{Auth::user()->email}}"--}}
{{--                                           readonly>--}}
{{--                                </div>--}}
...
{{--            </div>--}}
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title text-center">Update Profile Details</h4>
                        ...
                        <div class="col-lg-6">
                            <form method="post" action="{{ route('admin.profile.update', $user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="instructor_title" type="text"
                                           placeholder="Enter Title"
                                          value="{{ $user->instructor_title ?? '' }}">
                                </div>


                                <div class="mb-3">
                                    <label for="long_desc" class="form-label">Description</label>
                                    <textarea class="form-control" name="long_desc">{{ $user->long_desc }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if(isset($user->profile_image))
                                        <div class="mt-2">
                                            <img src="{{ asset($user->profile_image) }}" alt="Profile Image" width="100" height="100" />
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="payment_info">{{ $user->payment_info }}</textarea>
                                </div>
