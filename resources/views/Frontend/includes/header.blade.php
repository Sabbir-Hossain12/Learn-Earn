<style>
    ...
    .headerarea__login.dropdown:hover .dropdown-menu {
        display: block;
        margin-top: 0;
        opacity: 1;
        visibility: visible;
    ...
    .headerarea__login .dropdown-menu {
        display: none;
        opacity: 0;
        visibility: hidden;
...
<div class="topbararea--2 marquee-sec" style="background-color: #f2277e">
    <div class="container-flex">
        <div class="col-12">
            <marquee behavior="" direction="" style="color:#e8d9d9;margin-top: 2px;font-size: 22px;" scrolldelay="10"
                     scrollamount="5">
            ...
            <div class="row headerarea__search__wrap align-items-center">
                    ...
                    <div class="headerarea__2__inner justify-content-center">
                        <div class="headerarea__left">
                            <div class="headerarea__left__logo" style="height: 55px;">
                                ...
                                <a href="{{route('home')}}">
                                    <img loading="lazy" src="{{asset($basicInfo->light_logo)}}" width="187px"
                                         height="48px" alt="logo">
                                </a>
                            </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6">
                    <div class="headerarea__right">
                        ...
                        <div class="headerarea__login dropdown">
                            <a href="#" class="dropdown-toggle">
                                <i class="icofont-user-alt-5"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-start dashboard-dropdown-menu">
                                <div class="headerarea__login">
                                    <li><a class="text-dark dropdown-item mx-1 my-1"
                                           href="{{ route('student.dashboard.index') }}">Student Panel</a></li>
                                    <li><a class="dropdown-item text-dark mx-1 my-1"
                                           href="{{ url('admin/dashboards') }}">Teacher Panel</a></li>
                                </div>
                            </ul>
                        ...
                        <div class="headerarea__main__menu">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="headerarea__has__dropdown"
                                           id="{{Route::is('course-list') ? 'active-nav' : ''}}"
                                           href="{{route('course-list')}}">Courses
                                        </a>
                                    </li>

                                    <li>
                                        <a class="headerarea__has__dropdown"
                                           id="{{Route::is('teacher.page') ? 'active-nav' : ''}}"
                                           href="{{route('teacher.page')}}">Teachers
                                        </a>
                                    </li>

                                    <li>
                                        <a class="headerarea__has__dropdown"
                                           id="{{Route::is('blog-list') ? 'active-nav' : ''}}"
                                           href="{{route('blog-list')}}">Blogs
                                        </a>
                                    </li>
...
{{--                                    </li> --}}
                                    ...
                                    <li>
                                        <a class="headerarea__has__dropdown"
                                           id="{{Route::is('page') ? 'active-nav' : ''}}"
                                           href="{{route('page', 'about-us')}}">About Us
                                        </a>
                                    </li>
                ...
                <div class="col-6">
                    <div class="mobile-logo">
                        <a class="logo__dark" href="{{route('home')}}"><img loading="lazy"
                                                                            src="{{asset($basicInfo->light_logo ?? 'frontend/img/logo/logo_1.png')}}"
                                                                            alt="logo"></a>
                    </div>
                </div>
                <!--Login or dashboard-->
...
{{--                                       href="{{ route('student.dashboard.index') }}">Dashboard</a>--}}
...
{{--                            @endauth--}}
                            ...
                            <a class="btn btn-primary btn-sm" href="">Join Group</a>
    ...
    <div class="header-mobile-aside-wrap">
        ...
        <div class="mobile-curr-lang-wrap">
            <div class="single-mobile-curr-lang">
                <a class="mobile-account-active" href="javascript:void(0)">My Account <i class="icofont-thin-down"></i></a>
                <div class="lang-curr-dropdown account-dropdown-active">
                    <ul class="mobile-menu">
                        <li>
                            <a href="{{ route('student.dashboard.index') }}">Student Panel</a>
                        </li>

                        <li>
                            <a href="{{ url('admin/dashboards') }}">Teacher Panel</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mobile-social-wrap">
            ...
            <a class="google" href="{{ $basicInfo->youtube_link ?? '#' }}"><i
