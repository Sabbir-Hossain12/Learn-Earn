...
@section('content')
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-12" id="dashboardMainContent">
                        ...
                        <div class="dashboard__content__wraper" id="enrolledCourseSection">
                            ...
                            <div class="row mb-4 pb-4">
                                <div class="col-xl-4 col-lg-6 col-md-12 col-12 copy-link" data-link="{{ url('/') }}?ref={{ auth()->user()->ref_code }}"
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12 col-12 copy-link" data-link="{{ route('course-list') }}?ref={{ auth()->user()->ref_code }}"
                                     style="cursor: pointer;">
                                    <div class="dashboard__single__counter">
                                        <div class="counterarea__text__wraper">
                                            <div class="counter__img">
                            ...
                            <div class="row">
                                    ...
                                    <ul class="nav  about__button__wrap dashboard__button__wrap" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="single__tab__link active" data-bs-toggle="tab" data-bs-target="#projects__one"
                                                    type="button" aria-selected="true" role="tab"> My Shop
                                            </button>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content tab__content__wrapper aos-init aos-animate" id="myTabContent" data-aos="fade-up">
                                    ...
                                    <div class="tab-pane fade active show" id="projects__one" role="tabpanel" aria-labelledby="projects__one">
                                        <div class="row">
                                            @forelse($affiliateCourses as $affiliateCourse)
                                                <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                                    <div class="gridarea__wraper">
                                                        <div class="gridarea__img">

                                                            <a href="{{route('course-details', $affiliateCourse->course->slug)}}"><img loading="lazy" src="{{asset($affiliateCourse->course->thumbnail_img)}}" alt="grid"></a>
                                                            <div class="gridarea__small__button gridarea__small__button__1">
                                                                <div class="grid__badge">{{$affiliateCourse->course->class->title}}</div>
                                                            </div>
                                                        ...
                                                        <div class="gridarea__content">
                                                            <div class="gridarea__list">
                                                                <ul>
                                                                    <li>
                                                                        <i class="icofont-book-alt"></i> {{$affiliateCourse->course->lessons->count()}} Lessons
                                                                    </li>

                                                                    <li>
                                                                        <i class="icofont-clock-time"></i> {{$affiliateCourse->course->duration}}
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="gridarea__heading">
                                                                <h3><a href="{{route('course-lessons', $affiliateCourse->course->slug)}}">{{$affiliateCourse->course->title}}</a></h3>
                                                            </div>
                                                            <div class="gridarea__price">
                                                                ৳ {{$affiliateCourse->course->sale_price}} <del>/ ৳ {{$affiliateCourse->course->regular_price}}</del>
                                                                @if($affiliateCourse->course->sale_price=0)
                                                                    <span> Free</span>
                                                            ...
                                                            <div class="gridarea__bottom">
                                                                ...
                                                                <a href="{{route('teacher.details', $affiliateCourse->course->teacher->slug)}}">
                                                                    <div class="gridarea__small__img">
                                                                        <img loading="lazy" src="{{asset($affiliateCourse->course->teacher->profile_image ?? 'frontend/img/grid/grid_small_1.jpg')}}"  alt="grid">
                                                                        <div class="gridarea__small__content">
                                                                            <h6>{{$affiliateCourse->course->teacher->name}}</h6>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                ...
                                                                <!-- Copy button -->
                                                                <div class="copy-link"
                                                                     data-link="{{ route('course-details',$affiliateCourse->course->slug) }}?ref={{ auth()->user()->ref_code }}"
                                                                     style="cursor: pointer;">
    ...
    @push('js')
        ...
        //     Affiliate link copy
            ...
            $(document).ready(function () {
                // 1️⃣ Copy using `.copy-link`
                $(document).on('click', '.copy-link', function () {
                    let link = $(this).data('link'); // same as getAttribute('data-link')
                ...
                // 2️⃣ Copy using `.copy-btn` with target element
                $(document).on('click', '.copy-btn', function () {
                    let targetId = $(this).data('target'); // data-target attribute
                    let text = $('#' + targetId).text();   // grab text inside target element
